 ...
 * @author Felipe
 */
public class medicoCTRL extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (oper) {
                ...
                case "cadastrar":
                    ...
                    medicoMOD objmedico = new medicoMOD();
                    ...
                    if (objmedicodao.cadastrar(objmedico)) {
                        out.println("1");
                    } else {
                        out.println("0");
                    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(medicoCTRL.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
